...
public class StudentAndGradeServiceTest {
    ...
    public void studentInformationService() {
        ...
        assertEquals("madhav", gradebookCollegeStudentTest.getFirstname());
        assertEquals("anupoju", gradebookCollegeStudentTest.getLastname());
        assertEquals("madhav@123", gradebookCollegeStudentTest.getEmailAddress());
